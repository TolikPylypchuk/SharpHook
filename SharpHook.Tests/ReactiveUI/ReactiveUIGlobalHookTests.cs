...
public sealed class ReactiveUIGlobalHookTests
{
    ...
    public void IsRunning(GlobalHookType globalHookType)
    {
        ...
        var hook = new ReactiveUIGlobalHook(globalHookProvider: provider);
        ...
        EventMask mask)
    {
        ...
        var provider = new TestProvider();
        using var hook = new ReactiveUIGlobalHook(globalHookProvider: provider);
    ...
    [Fact(DisplayName = "ReactiveUIGlobalHook should not throw if the sequencer is null")]
    public void SequencerNull()
    {
        var exception = Record.Exception(() => new ReactiveUIGlobalHook(defaultSequencer: null));
        Assert.Null(exception);
    }

    [Fact(DisplayName = "ReactiveUIGlobalHook should not throw if the provider is null")]
    public void ProviderNull()
    {
        var exception = Record.Exception(() => new ReactiveUIGlobalHook(globalHookProvider: null));
        Assert.Null(exception);
    }

    private void RunHookAndWaitForStart(ReactiveUIGlobalHook hook, TestProvider provider, GlobalHookType globalHookType)
    {
    ...
    private void StopHookAndWaitForStop(ReactiveUIGlobalHook hook)
    {
        hook.Stop();
    ...
    private void DisposeHookAndWaitForStop(ReactiveUIGlobalHook hook)
    {
        hook.Dispose();
