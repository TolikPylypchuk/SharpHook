...
public sealed class ReactiveUIGlobalHookAdapterTests
{
    ...
    public void IsRunning(GlobalHookType globalHookType)
    {
        ...
        var hook = new ReactiveUIGlobalHookAdapter(new SimpleGlobalHook(provider));
        ...
        EventMask mask)
    {
        ...
        var provider = new TestProvider();
        using var hook = new ReactiveUIGlobalHookAdapter(new SimpleGlobalHook(provider));
    ...
    public void RunDisposed(GlobalHookType globalHookType)
    {
        ...
        var hook = new ReactiveUIGlobalHookAdapter(new SimpleGlobalHook());
        hook.Dispose();
    ...
    [Fact(DisplayName = "ReactiveUIGlobalHookAdapter should throw if the adapted hook is null")]
    public void AdaptedHookNull() =>
        Assert.Throws<ArgumentNullException>(() => new ReactiveUIGlobalHookAdapter(null!));

    [Fact(DisplayName = "SimpleReactiveUIGlobalHook should not throw if the sequencer is null")]
    public void SequencerNull()
    {
        var exception = Record.Exception(() => new ReactiveUIGlobalHookAdapter(new SimpleGlobalHook(), null));
        Assert.Null(exception);
    }

    private void RunHookAndWaitForStart(
        ReactiveUIGlobalHookAdapter hook,
    ...
    private void StopHookAndWaitForStop(ReactiveUIGlobalHookAdapter hook)
    {
        hook.Stop();
    ...
    private void DisposeHookAndWaitForStop(ReactiveUIGlobalHookAdapter hook)
    {
        hook.Dispose();
